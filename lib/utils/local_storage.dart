...
/// [value] 持久化存储的值
///
/// [原作者](https://github.com/JunAILiang/flutter_code/blob/master/lib/source_code/shared_preferences_example/j_sp_util.dart)
class LocalStorage {
  LocalStorage._internal();
  factory LocalStorage() => _instance;
  static late final LocalStorage _instance = LocalStorage._internal();
