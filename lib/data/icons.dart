...
/// here [pages](https://web.archive.org/web/20210728212734/https://flutter.github.io/cupertino_icons/)
/// 
/// ```js
/// const likeLists = $0.querySelectorAll(".icon-cell .icon-name")
/// let p = ''
/// Array.from(likeLists).map(item=> {
///   p += `CupertinoIcons.${ html }, \n`
/// })
/// // the output data is `p`
/// ```
List<IconData> cupertinoIconList = [
